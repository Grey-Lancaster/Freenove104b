...
// Not defined by this project's generic ESP32-S3-WROOM-1-N16R8 board variant
// (Freenove's own board package defines it per-variant); 40MHz matches the
// SPI_FREQUENCY already used for the TFT on this board.
#define BOARD_MAX_SDMMC_FREQ 40000000
#endif
